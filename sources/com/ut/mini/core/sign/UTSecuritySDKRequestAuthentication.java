...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    private Field f136a = null;

    /* renamed from: b  reason: collision with other field name */
    private Field f138b = null;

    /* renamed from: c  reason: collision with other field name */
    private Field f139c = null;

    /* renamed from: a  reason: collision with other field name */
    private Method f137a = null;
    private int z = 1;
    ...
    */
    ...
    public String getSign(String toBeSignedStr) {
        ...
        if (this.g == null) {
            ...
            if (this.b != null && (cls = this.a) != null && this.f136a != null && this.f138b != null && this.f139c != null && this.f137a != null && this.c != null) {
                try {
                    Object newInstance = cls.newInstance();
                    this.f136a.set(newInstance, this.g);
                    ((Map) this.f138b.get(newInstance)).put("INPUT", toBeSignedStr);
                    this.f139c.set(newInstance, Integer.valueOf(this.z));
                    return (String) this.f137a.invoke(this.c, newInstance, this.ad);
