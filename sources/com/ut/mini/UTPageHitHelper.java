...
public class UTPageHitHelper {
    ...
    private Queue<UTPageEventObject> f132a = new LinkedList();
    ...
    public static class UTPageEventObject {
        ...
        /* renamed from: a  reason: collision with other field name */
        private UTPageStatus f133a = null;
        ...
        public void resetPropertiesWithoutSkipFlagAndH5Flag() {
            ...
            this.an = null;
            this.ao = null;
            UTPageStatus uTPageStatus = this.f133a;
    ...
    synchronized void a(UTPageEventObject uTPageEventObject) {
        ...
        if (!this.f132a.contains(uTPageEventObject)) {
            this.f132a.add(uTPageEventObject);
        }
        if (this.f132a.size() > 200) {
            for (int i = 0; i < 100; i++) {
                UTPageEventObject poll = this.f132a.poll();
    ...
    private String m61a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m64a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m63a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m61a = m61a(obj);
        if (this.A.containsKey(m61a)) {
            return this.A.get(m61a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m61a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m61a);
    ...
    private synchronized void m62b(Object obj) {
        String m61a = m61a(obj);
        if (this.A.containsKey(m61a)) {
            this.A.remove(m61a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m61a = m61a(obj);
            if (m61a != null && m61a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
